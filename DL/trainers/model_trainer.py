...
class ModelTrainer:
    """
    Универсальный класс для обучения моделей.
    Поддерживает логику Background Loss, GAN Loss и работу с каскадными сетями.
    """
    ...
    def fit(self, train_loader: DataLoader, val_loader: DataLoader, epochs: int):
        for epoch in range(1, epochs + 1):
            ...
            print(
                f"Трейн Лосс: {train_metrics['loss']:.4f} | Точность: {train_metrics['acc']:.4f} | BG Лосс: {train_metrics['bg_loss']:.4f}")
